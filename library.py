...
path = PhotoImage(file='C:\\Users\\Satyam Singh\\OneDrive\\Desktop\\Python\\Library\\lib.png')
can.create_image(0,0,anchor=NW,image=path)

class library:

# Display all your records in database.
...
# DElete a particular book bt its unique Book Number.
    def deletebook(self):
        try:
            a= dele.get()
...
# Update any particular book in Database.
...
insert =Button(text="Insert Book",font=("Arial Black","11"),fg='white',bg="orange",relief=RAISED,command=data.insertbook)
...
delete =Button(text="Delete Book",font=("Arial Black","11"),fg='white',bg="orange",relief=RAISED,command =data.deletebook)
...
show =Button(text="Show All Books",font=("Arial Black","12"),fg='white',bg="orange",relief=RAISED,command=data.showbooks)
...
update =Button(text="Update Book",font=("Arial Black","11"),relief=RAISED,fg='white',bg="orange",command = data.updatebooks)
